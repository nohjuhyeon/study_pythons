...
#         plus_date = terms_dict[privacies[i].split()[1]]-1
#         date = [int(date.split('.')[0]),int(date.split('.')[1]),int(date.split('.')[2])]
#         date[0] = str(date[0] + (date[1] + (date[2]+plus_date)// 28) // 12)
#         date[1] = str((date[1] + (date[2]+plus_date)// 28) % 12)
#         date[2] = str((date[2]+plus_date)% 28)
#         if date[1] == '0':
#             date[1] = '12'
#         if date[2] == '0':
#             date[2] = '28'
